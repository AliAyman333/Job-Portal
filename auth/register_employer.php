            ...
            <div class="col-md-6">
                <div class="card form-card">
                    <div class="card-body p-5">
                        <h2 class="text-center mb-4">Register as Employer</h2>

                        <form method="post">
                            <div class="form-group mb-3">
                                <label class="form-label">Company Name</label>
                                <input type="text" name="name" class="form-control" placeholder="Enter your company name" required>
                            </div>
                            ...
                            <button type="submit" name="btnreg" class="btn btn-primary btn-lg w-100">Register</button>
                        </form>
...
if (isset($_POST['btnreg'])) {
    ...
    if (empty($name) || empty($email) || empty($pass)) {
        ...
        if (mysqli_num_rows($checkResult) > 0) {
            ...
            $stmt = mysqli_prepare($conc, "INSERT INTO users(role,name,email,password) VALUES('employer',?,?,?)");
